...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    if(carrotGroup.isTouching(kangaroo)){
      score = score+5
...
function spawnCarrots() {
  ...
  if (frameCount % 150 === 0) {
    ...
    var carrot = createSprite(camera.position.x+500,330,40,10);
    ...
    carrot.setCollider("rectangle",0,0,carrot.width/2,carrot.height/2)
